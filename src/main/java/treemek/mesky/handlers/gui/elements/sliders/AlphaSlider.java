...
public class AlphaSlider extends GuiButton{
	...
	public AlphaSlider(int buttonId, int x, int y, int width, int height, double current) {
	...
	ResourceLocation backgroundSlider = new ResourceLocation(Reference.MODID, "gui/transparencySlider.png");
	...
	public void drawSlider() {
		...
		drawModalRectWithCustomSizedTexture(xPosition, yPosition, 0, 0, width, height, width, width/3);
