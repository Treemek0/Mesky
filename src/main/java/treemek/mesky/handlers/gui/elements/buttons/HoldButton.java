...
public class HoldButton extends GuiButton{
	...
	ResourceLocation button = new ResourceLocation(Reference.MODID, "gui/moveVertical.png");
	ResourceLocation button_hovered = new ResourceLocation(Reference.MODID, "gui/moveVertical_hovered.png");
